-- Bundled by luabundle {"rootModuleName":"(Shadow Faction Die).4be61d.lua","version":"1.6.0"}
...
__bundle_register("(Shadow Faction Die).4be61d.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("(Shadow Faction Die).4be61d.lua")
