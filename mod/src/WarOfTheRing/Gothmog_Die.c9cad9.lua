-- Bundled by luabundle {"rootModuleName":"(Gothmog Die).c9cad9.lua","version":"1.6.0"}
...
__bundle_register("(Gothmog Die).c9cad9.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("(Gothmog Die).c9cad9.lua")
