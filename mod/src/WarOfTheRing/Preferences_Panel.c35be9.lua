-- Bundled by luabundle {"rootModuleName":"Preferences Panel.c35be9.lua","version":"1.6.0"}
...
__bundle_register("Preferences Panel.c35be9.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
require("PreferencesPanel")
end)
__bundle_register("PreferencesPanel", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Preferences Panel.c35be9.lua")
