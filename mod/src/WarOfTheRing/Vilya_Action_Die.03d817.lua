-- Bundled by luabundle {"rootModuleName":"(Vilya Action Die).03d817.lua","version":"1.6.0"}
...
__bundle_register("(Vilya Action Die).03d817.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("(Vilya Action Die).03d817.lua")
