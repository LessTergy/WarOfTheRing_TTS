-- Bundled by luabundle {"rootModuleName":"(Narya Action Die).76c749.lua","version":"1.6.0"}
...
__bundle_register("(Narya Action Die).76c749.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("(Narya Action Die).76c749.lua")
