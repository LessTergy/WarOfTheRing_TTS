...
function Roll1() RollCombatDice(1) end

function Roll2() RollCombatDice(2) end

function Roll3() RollCombatDice(3) end

function Roll4() RollCombatDice(4) end

function Roll5() RollCombatDice(5) end
    ...
    for D = 1, Num do
        local Die = self.takeObject({
            ...
            position = CalcSpot({
                ...
                Offset = { OffsetX - D * Gap, OffsetY, OffsetZ },
                Angle =
                    self.getRotation().y
            })
        })
...
function CalcSpot(Params) --Spot,Offset,Angle
    return vector(
        Params.Spot[1] +
        (Params.Offset[3] * math.sin(Params.Angle * Radians) + Params.Offset[1] * math.cos(Params.Angle * Radians)),
        Params.Spot[2] + Params.Offset[2],
        Params.Spot[3] +
        (Params.Offset[3] * math.cos(Params.Angle * Radians) - Params.Offset[1] * math.sin(Params.Angle * Radians)))
end

function DisplayButtons()
    self.clearButtons()
    self.createButton({
        click_function = "ResetDice",
        function_owner = self,
        label = "x",
        position = { -0.42, 0.5, -0.6 },
        rotation = { 0, 0, 0 },
        scale = { 0.25, 0.5, 0.5 },
        color =
            DiceColor,
        ...
        font_size = 300,
        font_color = PipColor,
        tooltip = "Clear this Panel's Dice."
    })
    self.createButton({
        click_function = "Roll1",
        function_owner = self,
        label = "1",
        position = { -0.28, 0.5, -0.6 },
        rotation = { 0, 0, 0 },
        scale = { 0.25, 0.5, 0.5 },
        color =
            DiceColor,
        ...
        font_size = 300,
        font_color = PipColor,
        tooltip = "Roll 1 Combat Dice."
    })
    self.createButton({
        click_function = "Roll2",
        function_owner = self,
        label = "2",
        position = { -0.14, 0.5, -0.6 },
        rotation = { 0, 0, 0 },
        scale = { 0.25, 0.5, 0.5 },
        color =
            DiceColor,
        ...
        font_size = 300,
        font_color = PipColor,
        tooltip = "Roll 2 Combat Dice."
    })
    self.createButton({
        click_function = "Roll3",
        function_owner = self,
        label = "3",
        position = { 0, 0.5, -0.6 },
        rotation = { 0, 0, 0 },
        ...
        font_size = 300,
        font_color = PipColor,
        tooltip = "Roll 3 Combat Dice."
    })
    self.createButton({
        click_function = "Roll4",
        function_owner = self,
        label = "4",
        position = { 0.14, 0.5, -0.6 },
        rotation = { 0, 0, 0 },
        ...
        font_size = 300,
        font_color = PipColor,
        tooltip = "Roll 4 Combat Dice."
    })
    self.createButton({
        click_function = "Roll5",
        function_owner = self,
        label = "5",
        position = { 0.28, 0.5, -0.6 },
        rotation = { 0, 0, 0 },
        ...
        font_size = 300,
        font_color = PipColor,
        tooltip = "Roll 5 Combat Dice."
    })
    self.createButton({
        click_function = "ReportDiceStats",
        ...
        font_size = 300,
        font_color = PipColor,
        tooltip = "Display Dice Statistics."
    })
end
