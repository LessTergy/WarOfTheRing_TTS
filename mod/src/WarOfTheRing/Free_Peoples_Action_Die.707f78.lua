-- Bundled by luabundle {"rootModuleName":"(Free Peoples Action Die).707f78.lua","version":"1.6.0"}
...
__bundle_register("(Free Peoples Action Die).707f78.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("(Free Peoples Action Die).707f78.lua")
