-- Bundled by luabundle {"rootModuleName":"(Balrog Die).e7073a.lua","version":"1.6.0"}
...
__bundle_register("(Balrog Die).e7073a.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("(Balrog Die).e7073a.lua")
