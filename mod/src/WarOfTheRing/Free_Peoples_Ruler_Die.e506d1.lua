-- Bundled by luabundle {"rootModuleName":"(Free Peoples Ruler Die).e506d1.lua","version":"1.6.0"}
...
__bundle_register("(Free Peoples Ruler Die).e506d1.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("(Free Peoples Ruler Die).e506d1.lua")
