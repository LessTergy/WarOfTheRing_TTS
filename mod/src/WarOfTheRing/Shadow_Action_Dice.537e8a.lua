-- Bundled by luabundle {"rootModuleName":"Shadow Action Dice.537e8a.lua","version":"1.6.0"}
...
__bundle_register("Shadow Action Dice.537e8a.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Shadow Action Dice.537e8a.lua")
