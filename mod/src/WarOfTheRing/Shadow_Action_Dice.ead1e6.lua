-- Bundled by luabundle {"rootModuleName":"Shadow Action Dice.ead1e6.lua","version":"1.6.0"}
...
__bundle_register("Shadow Action Dice.ead1e6.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Shadow Action Dice.ead1e6.lua")
