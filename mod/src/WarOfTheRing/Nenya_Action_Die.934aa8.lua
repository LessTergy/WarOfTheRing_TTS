-- Bundled by luabundle {"rootModuleName":"(Nenya Action Die).934aa8.lua","version":"1.6.0"}
...
__bundle_register("(Nenya Action Die).934aa8.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("(Nenya Action Die).934aa8.lua")
