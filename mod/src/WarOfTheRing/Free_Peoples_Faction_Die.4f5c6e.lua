-- Bundled by luabundle {"rootModuleName":"(Free Peoples Faction Die).4f5c6e.lua","version":"1.6.0"}
...
__bundle_register("(Free Peoples Faction Die).4f5c6e.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("(Free Peoples Faction Die).4f5c6e.lua")
